...
|---|---|---|
| 1. **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Gabriel Sebastián Borja Molina** <br> TB1 <br> Investigar a fondo herramientas como Bounded Contexts es una acción que refleja directamente el objetivo de actualizar conocimientos y habilidades. La aplicación de este principio del Domain-Driven Design permitió segmentar el dominio del negocio en partes coherentes y autónomas como Libros, Carrito y Comunidades, lo que se tradujo en un diseño de base de datos y una arquitectura de software precisos y eficientes. <br><br> **Marcelo Alejandro Binda Arbañil** <br> TB1 <br> Investigar y aplicar Domain Message Flows es una acción que refleja directamente el objetivo de actualizar conocimientos y habilidades. La aplicación de este principio del Domain-Driven Design permitió modelar el flujo de mensajes entre los diferentes contextos de la aplicación. Esto se tradujo en una arquitectura de software precisa y eficiente, asegurando que las interacciones entre dominios, como la creación de una Orden a partir de un Carrito, fueran claras y desacopladas. <br><br> **Ainhoa Lucía Castillo Garay** <br> TB1 <br> Investigar y aplicar el modelo C4 es una acción que refleja directamente el objetivo de actualizar conceptos y conocimientos. Al emplear esta metodología, se pudo documentar la arquitectura del software de forma clara y jerárquica, lo que se tradujo en una comunicación más efectiva y una comprensión compartida del sistema. Esto aseguró que todos los miembros del equipo tuvieran una visión unificada de la estructura de la aplicación, desde sus componentes de alto nivel hasta el código. <br><br> **Cassius Estefano Martel Andrade** <br> TB1 <br> Investigar y aplicar los principios de la arquitectura por capas es una acción que refleja directamente el objetivo de actualizar conceptos y conocimientos. Esta metodología permitió organizar el código del proyecto de forma clara, separando las responsabilidades de cada componente para lograr un sistema más mantenible y escalable. Esto se tradujo en la capacidad de aislar la lógica de negocio en la capa de Domain, gestionar la presentación en la capa de Interface, coordinar las operaciones en la capa de Application y manejar los servicios externos como la base de datos en la capa de Infrastructure. <br><br> **Alex Tomio Nakamurakare Teruya** <br> TB1 <br> Investigar y aplicar Bounded Context Canvases es una acción que refleja directamente el objetivo de actualizar conocimientos y habilidades. Esta metodología permitió documentar de forma concisa cada subdominio del proyecto, definiendo sus responsabilidades, entidades clave y las interacciones con otros contextos. Esto se tradujo en una comprensión más clara y una mejor comunicación dentro del equipo, asegurando que el diseño de cada parte del sistema fuera coherente y alineado con los objetivos del negocio. | **TB1** <br> Durante esta primera etapa del proyecto, hemos reforzado, actualizado y aplicado los conocimientos adquiridos a lo largo de la carrera. Este proceso de repaso e investigación nos ayudó a consolidar conceptos clave y aplicarlos de manera efectiva para el desarrollo inicial de nuestra propuesta. |
| 2. **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Gabriel Sebastián Borja Molina** <br> TB1 <br> Investigar y aplicar metodologías de diseño orientadas tanto a la base de datos como a la experiencia del usuario refleja la importancia del aprendizaje continuo. El uso de diagramas de base de datos en un Bounded Context, junto con User Personas y Event Storming, permitió actualizar y consolidar conocimientos especializados. Gracias a ello, se logró traducir procesos de negocio complejos en un modelo de datos funcional, al tiempo que se capturaron las necesidades del usuario, estableciendo una base técnica y de usabilidad sólida para el proyecto. <br><br> **Marcelo Alejandro Binda Arbañil** <br> TB1 <br> Investigar y aplicar metodologías centradas en el usuario y el negocio refleja la importancia del aprendizaje continuo en la formación profesional. El uso de herramientas como Lean UX Process, Event Storming, User Journey Mapping, Análisis Competitivo y Entrevistas permitió actualizar y consolidar conocimientos clave. Como resultado, se identificaron las necesidades principales de los usuarios y las dinámicas del negocio, asegurando que el diseño de la solución responda de manera efectiva y centrada en el cliente. <br><br> **Ainhoa Lucía Castillo Garay** <br> TB1 <br> Investigar y aplicar metodologías avanzadas de arquitectura y descubrimiento de negocio refleja la importancia del aprendizaje continuo en el desarrollo profesional. El uso de diagramas de arquitectura (Contexto, Contenedor y Despliegue), junto con el Context Mapping y el Candidate Context Discovery, permitió actualizar y afianzar conocimientos especializados. Gracias a ello, se definió un marco arquitectónico sólido que servirá de base estratégica para las siguientes etapas del proyecto. <br><br> **Cassius Estefano Martel Andrade** <br> TB1 <br> Investigar y aplicar conceptos avanzados de arquitectura de software y metodologías ágiles es una acción que refleja directamente la importancia del aprendizaje continuo en el desarrollo profesional. El uso de diagramas, Impact Mapping y User Stories permitió consolidar un diseño inicial claro y fundamentado, demostrando que la actualización constante de conocimientos es clave en el desarrollo de proyectos de software. <br><br> **Alex Tomio Nakamurakare Teruya** <br> TB1 <br> Investigar y aplicar metodologías de diseño colaborativo refleja la importancia del aprendizaje continuo en el desarrollo de soluciones de software. El uso de diagramas de base de datos, Event Storming y Bounded Context Canvases permitió actualizar y afianzar conocimientos para afrontar los retos del proyecto. Como resultado, se tradujo la información obtenida en entrevistas y workshops en un modelo de datos estructurado y preciso, estableciendo una base técnica sólida para el desarrollo de la solución. | **TB1** <br> Durante la elaboración del primer avance del proyecto, hemos comprendido la importancia de mantener nuestros conocimientos actualizados y aprender constantemente. Para estructurar el diseño y presentación de nuestra propuesta ha sido necesario consultar nuevas fuentes y repasar conceptos, con el objetivo de que nuestra solución sea sólida y esté correctamente fundamentada. |
