...
|---|---|---|---|
| 1.0 (TB1) | 08/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo I: Presentación**<br> - 1.1. Startup Profile (Descripción de la Startup y perfiles del equipo)<br> - 1.2. Solution Profile (Antecedentes y problemática)<br> - 1.2.2.1. Lean UX Problem Statements (Definición de los problemas a resolver)<br> - 1.2.2.2. Lean UX Assumptions (Identificación de suposiciones)<br> - 1.2.2.3. Lean UX Hypothesis Statements (Formulación de hipótesis)<br> - 1.3. Segmentos objetivo (Definición del público meta) |
| 1.1 (TB1) | 09/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo I: Presentación y Capítulo II: Requirements Development**<br> - 1.2.2.4. Lean UX Canvas (Creación del lienzo de Lean UX)<br> - 2.1.1. Análisis competitivo (Investigación de competidores)<br> - 2.1.2. Estrategias y tácticas frente a competidores (Definición de estrategias competitivas)<br> - 2.2.1. Diseño de entrevistas (Creación de guiones de entrevistas) |
| 1.2 (TB1) | 10/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo II: Requirements Development**<br> - 2.2.2. Registro de entrevistas (Toma de notas de las entrevistas)<br> - 2.2.3. Análisis de entrevistas (Análisis de los resultados de las entrevistas)<br> - 2.3.1. User Personas (Creación de perfiles de usuario)<br> - 2.3.2. User Task Matrix (Mapeo de tareas de usuario) |
| 1.3 (TB1) | 11/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo II: Requirements Development and Design**<br> - 2.3.3. User Journey Mapping (Mapeo del viaje del usuario)<br> - 2.3.4. Empathy Mapping (Creación de mapas de empatía)<br> - 2.3.5. Ubiquitous Language (Definición del lenguaje común del dominio)<br> - 2.4.1. User Stories (Redacción de historias de usuario)<br> - 2.4.2. Impact Mapping (Mapeo de impacto)<br> - 2.4.3. Product Backlog (Creación de la lista de pendientes del producto) |
| 1.4 (TB1) | 12/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo II: Strategic-Level Domain-Driven Design**<br> - 2.5.1. EventStorming (Modelado de flujos de eventos)<br> - 2.5.1.1. Candidate Context Discovery (Identificación de contextos candidatos)<br> - 2.5.1.2. Domain Message Flows Modeling (Modelado de flujos de mensajes)<br> - 2.5.1.3. Bounded Context Canvases (Creación de lienzos de contextos) |
| 1.5 (TB1) | 13/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo II: Strategic-Level Domain-Driven Design**<br> - 2.5.2. Context Mapping (Mapeo de los contextos)<br> - 2.5.3. Software Architecture (Diseño de la arquitectura del software)<br> - 2.5.3.1. Context Level Diagrams (Diagramas a nivel de contexto)<br> - 2.5.3.2. Container Level Diagrams (Diagramas a nivel de contenedores)<br> - 2.5.3.3. Deployment Diagrams (Diagramas de despliegue) |
| 1.6 (TB1) | 14/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo II: Tactical-Level Domain-Driven Design**<br> - 2.6.x. Bounded Context: Búsqueda, Libro, Recomendaciones, Carrito<br> - 2.6.x.1. Domain Layer (Diseño de la capa de dominio)<br> - 2.6.x.2. Interface Layer (Diseño de la capa de interfaz)<br> - 2.6.x.3. Application Layer (Diseño de la capa de aplicación)<br> - 2.6.x.4. Infrastructure Layer (Diseño de la capa de infraestructura) |
| 1.7 (TB1) | 15/09/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo II: Tactical-Level Domain-Driven Design**<br> - 2.6.x. Bounded Context: Perfil, Órdenes, Stock, Comunidades<br> - 2.6.x.1. Domain Layer<br> - 2.6.x.2. Interface Layer<br> - 2.6.x.3. Application Layer<br> - 2.6.x.4. Infrastructure Layer |
...
| 2.9 (TP) | 09/10/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation **<br>- 4.2.1.5 a 4.2.1.8 Evidencias del Sprint<br>- 4.3. Validation Interviews (Diseño, Registro, Evaluaciones)<br>- Actualización de Conclusiones y Recomendaciones<br>- Actualización de ReadMe<br>- Preparación de PPT y Video de Exposición<br>- Reporte de Participación |
| 3.0 (TB2) | 03/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | - Revisión de User Flows<br>**Capítulo IV: Product Implementation & Validation**<br>- 4.2.2.1. Sprint Planning 2<br>- 4.2.2.3 .Sprint Backlog 2 |
| 3.1 (TB2) | 04/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation**<br>- 4.2.3.1. Sprint Planning 3<br>- 4.2.3.2 Spring Backlog 3 |
| 3.2 (TB2) | 05/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | - Primera Revisión de User Stories<br>- Actualización de carátula<br>**Capítulo IV: Product Implementation & Validation**<br>- 4.2.2.3. Development Evidence For Sprint Review |
...
| 4.0 (TF) | 25/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation**<br>- 4.2.3.3. Development Evidence For Sprint Review |
| 4.1 (TF) | 26/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation**<br>- 4.2.3.4. Testing Suite Evidence For Sprint Review |
| 4.2 (TF) | 27/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation**<br>- 4.2.3.5. Execution Evidence For Sprint Review |
| 4.3 (TF) | 28/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation**<br>- 4.2.3.6. Services Documentation Evidence For Sprint Review<br>- 4.2.3.7. Software  Evidence For Sprint Review |
| 4.4 (TF) | 29/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | **Capítulo IV: Product Implementation & Validation**<br>- 4.2.3.8. Team Collaboration Insights |
| 4.5 (TF) | 30/11/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | - Mejoras en el código de LivriaAdmin y LivriaClient |
| 4.6 (TF) | 01/12/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | - Actualización de Student Outcome<br>- Actualización de Bibliografía<br>- Actualización de Project Report Collaboration Insights |
| 4.7 (TF) | 02/12/25 | - Binda Arbañil, Marcelo Alejandro<br>- Borja Molina, Gabriel Sebastián<br>- Castillo Garay, Ainhoa Lucía<br>- Martel Andrade, Cassius Estefano<br>- Nakamurakare Teruya, Alex Tomio | - Inserción de Enlaces de videos de validación, About-The-Team y About-The-Product<br>- Actualización de Conclusiones y Recomendaciones<br>- Actualización de Registro de Versiones del Informe |
  ...
  + [4. Product Implementation & Validation](#4-product-implementation-validation)
    ...
    + [4.2. Landing Page & Mobile Application Implementation](#42-landing-page-mobile-application-implementation)
      ...
      - [4.2.2. Sprint 2](#422-sprint-2)
        ...
        - [4.2.2.4. Testing Suite Evidence for Sprint Review](#4224testing-suite-evidence-for-sprint-review)
        - [4.2.2.5. Execution Evidence for Sprint Review](#4225-execution-evidence-for-sprint-review)
        - [4.2.2.6. Services Documentation Evidence for Sprint Review](#4226-services-documentation-evidence-for-sprint-review)
        - [4.2.2.7. Software Deployment Evidence for Sprint Review](#4227-software-deployment-evidence-for-sprint-review)
        - [4.2.2.8. Team Collaboration Insight during Sprint](#4228-team-collaboration-insight-during-sprint)
...
|---|---|---|
| 1. **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **Gabriel Sebastián Borja Molina** <br> **TB1:** Investigó *Bounded Contexts* y condujo al equipo en su aplicación, fortaleciendo comunicación clara, pensamiento crítico, colaboración y organización para alinear criterios entre Libros, Carrito y Comunidades. Además, promovió espacios de alineación que reforzaron la confianza y la coordinación del equipo. <br> **TP:** Aplicó principios de diseño responsivo y guías de Material Design para la construcción de la Landing Page y vistas móviles. Su investigación en patrones de usabilidad y arquitectura visual mejoró la coherencia estética y funcional del producto. <br> **TB2:** Reforzó sus conocimientos técnicos aplicándolos directamente en el desarrollo del producto. Investigó nuevas prácticas de arquitectura y estándares de desarrollo que posteriormente compartió con el equipo, promoviendo una comunicación clara y activa. Su capacidad de análisis y organización contribuyó a optimizar la estructura del proyecto y mejorar la alineación del equipo en criterios técnicos y funcionales. <br> **TF:** Lideró la estandarización visual de los módulos finales (Checkout y Perfil), asegurando la coherencia con Material Design y la adaptabilidad responsiva. Investigó patrones de *Optimistic UI* para mejorar la percepción de velocidad en interacciones críticas, elevando el estándar de usabilidad del producto final. <br><br> **Marcelo Alejandro Binda Arbañil** <br> **TB1:** Modeló *Domain Message Flows* entre contextos; destacó su escucha activa, negociación, co-diseño y síntesis para acuerdos claros, además de redacción precisa para guiar al equipo. Su enfoque facilitador elevó el clima de trabajo y la toma de decisiones compartidas. <br> **TP:** Implementó la estructura de gestión de código, aplicando convenciones y estándares de desarrollo. Documentó procesos y aseguró la correcta integración del código fuente, promoviendo buenas prácticas profesionales. <br> **TB2:** Aplicó conceptos clave de control de versiones, documentación y estandarización de código para fortalecer el desarrollo colaborativo del proyecto. Su capacidad de síntesis y claridad al estructurar procesos facilitó el entendimiento común, promoviendo buenas prácticas y mejorando la calidad técnica general del entregable. <br> **TF:** Gestionó la integración final del repositorio en GitHub, asegurando la calidad del código mediante la revisión de *Pull Requests* complejos relacionados con la lógica de negocio. Documentó la estructura final del proyecto, garantizando que la arquitectura cumpliera con los estándares de mantenibilidad exigidos profesionalmente. <br><br> **Ainhoa Lucía Castillo Garay** <br> **TB1:** Difundió el modelo C4 con material didáctico, mostrando *storytelling* técnico, capacidad de síntesis visual, claridad expositiva y feedback constructivo en revisiones por pares. Su habilidad para traducir complejidad en narrativas claras aumentó la participación y el entendimiento colectivo. <br> **TP:** Diseñó *wireframes* y *mockups* de alta fidelidad, incorporando guías de accesibilidad y heurísticas de Nielsen. Su aporte garantizó la calidad visual y la usabilidad de la aplicación. <br> **TB2:** Fortaleció sus conocimientos en usabilidad y diseño aplicando heurísticas de diseño, accesibilidad y buenas prácticas UX/UI en el desarrollo del producto. Su enfoque detallado y orientado a la calidad contribuyó a la construcción de interfaces claras, funcionales y alineadas con estándares profesionales, beneficiando la experiencia de usuario. <br> **TF:** Evaluó la accesibilidad y usabilidad de los nuevos flujos transaccionales (pagos y suscripción), aplicando heurísticas para reducir la fricción en formularios complejos. Su validación aseguró que la experiencia de usuario se mantuviera intuitiva incluso ante errores de sistema o conectividad. <br><br> **Cassius Estefano Martel Andrade** <br> **TB1:** Impulsó la arquitectura por capas, ejerciendo liderazgo situacional, mentoría, gestión del tiempo y disciplina organizacional para separar responsabilidades y facilitar el trabajo del equipo. Su acompañamiento constante redujo fricciones y elevó el nivel de compromiso del grupo. <br> **TP:** Coordinó la implementación técnica del *frontend* móvil y la integración con la base de datos. Introdujo nuevas herramientas y metodologías ágiles, optimizando la planificación de *sprints* y el control de versiones. <br> **TB2:** Amplió y aplicó conocimientos clave en desarrollo multiplataforma, arquitectura y gestión ágil del proyecto. Su liderazgo técnico y coordinación del equipo facilitaron la integración de componentes esenciales del producto, promoviendo una ejecución organizada, eficiente y alineada con los objetivos del curso. <br> **TF:** Orquestó la implementación de la Arquitectura Limpia en los módulos de Órdenes y Perfil, coordinando la separación entre la lógica de estado (*Provider*) y la interfaz. Gestionó el *Sprint* final priorizando la integración de servicios externos críticos como Stripe, asegurando la entrega funcional del MVP. <br><br> **Alex Tomio Nakamurakare Teruya** <br> **TB1:** Facilitó *Bounded Context Canvases* priorizando empatía con *stakeholders*, facilitación de dinámicas, alineamiento de objetivos y toma de decisiones participativa. Esta conducción generó acuerdos más ágiles y una cultura de respeto por perspectivas diversas. <br> **TP:** Dirigió las validaciones y pruebas del prototipo, aplicando conocimientos de UX Research y control de calidad. Su análisis permitió mejorar la experiencia del usuario final y la presentación del entregable. <br> **TB2:** Reforzó sus conocimientos en validación, pruebas y análisis de experiencia de usuario, aplicando estrategias que permitieron mejorar la calidad del producto antes de su presentación. Su enfoque crítico y orientado al detalle contribuyó a identificar oportunidades de mejora, elevando el estándar del entregable final. <br> **TF:** Validó el cumplimiento de las reglas de negocio en la integración con el Backend, específicamente en el manejo de suscripciones y validación de stock. Su análisis de los flujos de excepción permitió implementar un manejo de errores robusto, mejorando la confiabilidad del sistema ante el usuario final. | **TB1:** Durante esta primera etapa del proyecto, reforzamos, actualizamos y aplicamos los conocimientos adquiridos a lo largo de la carrera. Este proceso de repaso e investigación nos ayudó a consolidar conceptos clave y aplicarlos de manera efectiva para el desarrollo inicial de nuestra propuesta. <br><br> **TP:** En el desarrollo del TP fortalecimos y actualizamos nuestros conocimientos técnicos aplicando nuevas herramientas de diseño, desarrollo y validación. La experiencia permitió integrar conceptos de ingeniería de software con diseño UX/UI, consolidando un enfoque más profesional y completo hacia la solución final. <br><br> **TB2:** Consolidamos y actualizamos nuestros conocimientos técnicos aplicándolos de manera práctica y articulada en el desarrollo del producto. La integración de conceptos de arquitectura, diseño, usabilidad, gestión de repositorio y validaciones permitió incrementar la calidad del software y fortalecer el trabajo colaborativo. Esta etapa marcó un avance significativo en la madurez técnica del equipo, reflejada en un entregable más completo, funcional y alineado a estándares profesionales. <br><br> **TF:** En esta etapa final, integramos la totalidad de los conocimientos técnicos y metodológicos adquiridos para desplegar una solución de software completa. La implementación de patrones de arquitectura avanzados (*Clean Architecture, Provider*) y la integración de servicios externos (*Stripe*) evidencian nuestra capacidad para construir aplicaciones escalables y alineadas con las exigencias actuales de la industria. |
| 2. **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.** | **Gabriel Sebastián Borja Molina** <br> **TB1:** Combinó diagramas de datos con *User Personas* y *Event Storming*, evidenciando mentalidad de crecimiento, curiosidad, autoaprendizaje y gestión del tiempo. Además, instauró rutinas de revisión que sostuvieron el foco y el ritmo de avance. <br> **TP:** Profundizó en herramientas de diseño colaborativo (Figma, FigJam) y frameworks modernos de UI. Su constante actualización en recursos de diseño contribuyó a mantener la propuesta competitiva y moderna. <br> **TB2:** Demostró una actitud constante de mejora continua explorando nuevas herramientas y recursos de diseño y desarrollo, lo cual enriqueció la calidad del producto y del flujo de trabajo del equipo. Su disposición al autoaprendizaje y a incorporar nuevos conocimientos en la práctica favoreció la evolución del proyecto y motivó al equipo a mantenerse actualizado y abierto a nuevas metodologías. <br> **TF:** Investigó patrones de interacción social digital para optimizar la experiencia en **Comunidades**, mostrando una curiosidad intelectual que trascendió el código. Su disposición para aprender sobre dinámicas de grupo enriqueció la funcionalidad, demostrando que el aprendizaje continuo es clave para crear software con impacto social. <br><br> **Marcelo Alejandro Binda Arbañil** <br> **TB1:** Aplicó Lean UX, *User Journey*, análisis competitivo y entrevistas; fortaleció empatía con el usuario, comunicación, trabajo en equipo y mejora continua. Su mirada empática aseguró que las decisiones técnicas mantuvieran el valor para el usuario final. <br> **TP:** Asimiló nuevas metodologías de control de versiones y entornos de despliegue, adaptándose a contextos técnicos más exigentes. Su aprendizaje activo fortaleció la calidad y consistencia del código entregado. <br> **TB2:** Asumió nuevos retos vinculados al manejo de repositorios, entornos de despliegue y automatización del flujo de trabajo, demostrando adaptabilidad y compromiso con el aprendizaje continuo. Al integrar estos nuevos conocimientos, aportó mejoras significativas al proceso técnico del equipo y evidenció una mentalidad de crecimiento profesional. <br> **TF:** Enfrentó el desafío de integrar servicios de geolocalización (**Google Maps**) con gran autonomía, aprendiendo sobre gestión de ubicación y APIs en tiempo real. Su resiliencia ante la complejidad técnica de los servicios externos reafirmó su compromiso con la autoformación y la excelencia técnica. <br><br> **Ainhoa Lucía Castillo Garay** <br> **TB1:** Elaboró artefactos de arquitectura y *Context Mapping*; cultivó atención al detalle, claridad, orden y colaboración interfuncional. Su disciplina documental facilitó el *onboarding* y la continuidad del trabajo entre miembros. <br> **TP:** Integró prácticas de validación con usuarios y testing de interfaz, demostrando aprendizaje autónomo y compromiso con la mejora continua. <br> **TB2:** Mostró iniciativa en la búsqueda de nuevas metodologías de validación y herramientas de diseño colaborativo que aportaron valor al desarrollo visual del producto. Su apertura a recibir y aplicar feedback fomentó la mejora continua del diseño y consolidó un enfoque más completo y profesional hacia la evolución de la solución. <br> **TF:** Profundizó en los principios avanzados de **UI y Material Design**, manteniendo una actitud abierta a la evolución de las tendencias visuales. Su búsqueda constante de la excelencia estética demostró que el aprendizaje en diseño es un proceso iterativo fundamental para el éxito y la aceptación del producto en el mercado. <br><br> **Cassius Estefano Martel Andrade** <br> **TB1:** Coordinó *Impact Mapping* y *User Stories*; demostró planificación, priorización, liderazgo y adaptabilidad ante cambios. Además, promovió acuerdos operativos claros que ordenaron prioridades y tiempos. <br> **TP:** Estudió herramientas de desarrollo multiplataforma y coordinó procesos de integración. Su búsqueda constante de optimización técnica y metodológica fortaleció la calidad del proyecto. <br> **TB2:** Demostró un compromiso constante con el aprendizaje, explorando nuevas herramientas y metodologías que fortalecieron el proceso de desarrollo y la calidad del producto. Su capacidad para adaptarse, evaluar alternativas y promover su implementación refleja una mentalidad proactiva orientada al crecimiento y a la mejora continua del equipo. <br> **TF:** Se capacitó en protocolos de seguridad y tokenización financiera para implementar **Stripe**, evidenciando una gestión responsable del riesgo y el aprendizaje. Su enfoque en dominar tecnologías críticas para el negocio demostró una visión profesional orientada a la sostenibilidad y la adaptabilidad ante nuevos estándares de pago. <br><br> **Alex Tomio Nakamurakare Teruya** <br> **TB1:** Condujo sesiones colaborativas (*Event Storming*, *Canvas*) integrando feedback, resiliencia y capacidad de síntesis para converger en decisiones. Su apertura al feedback potenció el consenso y el aprendizaje entre pares. <br> **TP:** Aprendió e implementó técnicas de validación de usabilidad, análisis de métricas y documentación estructurada para mejorar la presentación final. Su disposición a aprender garantizó la solidez del entregable. <br> **TB2:** Mostró disposición por adquirir y aplicar nuevas técnicas de investigación de usabilidad, métricas de evaluación y documentación estructurada. Su capacidad de adaptación y aprendizaje continuo fortaleció el proceso de validación, asegurando un producto más sólido y mejor fundamentado desde la perspectiva del usuario. <br> **TF:** Exploró algoritmos de filtrado para **recomendaciones** y sistemas de **notificaciones**, demostrando una mentalidad analítica orientada a la personalización. Su interés por entender cómo los datos impulsan el *engagement* reflejó una clara orientación hacia el aprendizaje de técnicas que maximizan el valor percibido del software. | **TB1:** Durante la elaboración del primer avance del proyecto, comprendimos la importancia de mantener nuestros conocimientos actualizados y aprender constantemente. Para estructurar el diseño y presentación de nuestra propuesta fue necesario consultar nuevas fuentes y repasar conceptos, con el objetivo de que nuestra solución sea sólida y correctamente fundamentada. <br><br> **TP:** A lo largo del TP fortalecimos nuestro compromiso con el aprendizaje continuo mediante la adopción de nuevas tecnologías, herramientas de diseño y metodologías ágiles. Este proceso nos permitió evolucionar como equipo, asumir roles más especializados y entregar una solución más completa, validada y profesional. <br><br> **TB2:** Demostramos una clara conciencia sobre la importancia del aprendizaje continuo para el desarrollo profesional y el éxito del proyecto. La disposición a incorporar nuevas tecnologías, metodologías y herramientas impulsó la evolución del producto y promovió un ambiente de mejora constante. Este enfoque permitió afrontar desafíos con mayor criterio, adaptabilidad y autonomía, consolidando un equipo más preparado y con mayor capacidad de innovación y crecimiento. <br><br> **TF:** Ratificamos que el aprendizaje continuo es el motor fundamental para el éxito de cualquier proyecto de software. La necesidad de integrar tecnologías emergentes, cumplir con estándares de seguridad y optimizar la experiencia de usuario nos impulsó a investigar y aplicar nuevos conceptos constantemente, demostrando que la adaptabilidad es una competencia esencial para nuestro futuro profesional. |
...
| **TS14: Acceder a barra de navegación (Admin)** | | | | | | | |
| | 1 | Componente Sidebar | Desarrollar la barra con los enlaces a las secciones principales (Books, Orders, etc.). | 2 | Developer Team | Done |
| | 2 | Estado Activo y Navegación | Destacar la sección activa y asegurar navegación fluida entre vistas. | 1 | Developer Team | Done |
